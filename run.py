...
def get_args():
    ...
    parser.add_argument('--model', type=str, default='PeriodformerED',
                        help='model name, options: [Periodformer, Informer, Transformer]')
    ...
    parser.add_argument('--label_len', type=int, default=48, help='input sequence length')
...
if __name__=='__main__':
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}'.format(
                args.model_id,
                args.model,
                args.data,
                args.features,
        ...
        ii = 0
        setting = '{}_{}_{}_ft{}_sl{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}'.format(args.model_id,
                                                                                                      args.model,
                                                                                                      args.data,
                                                                                                      args.features,
                                                                                                      args.seq_len,
